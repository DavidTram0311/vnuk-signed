...
def strip_bom_and_newline(dataset):
    ...
    :param dataset: A DatasetDict object.
    :return: A new DatasetDict object with stripped fields.
    """
...
def split_dataset(dataset, train_ratio=0.8, validation_ratio=0.1, test_ratio=0.1):
    ...
    :param validation_ratio: The ratio of the dataset to use for validation.
    :param test_ratio: The ratio of the dataset to use for testing.
    :return: A DatasetDict containing the train, validation, and test splits.
    """
