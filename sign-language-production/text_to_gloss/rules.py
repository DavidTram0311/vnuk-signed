...
# last updated for this project: Hieu Nguyen / Dat Tram
"""
This rule-based module is used to extract glosses from a sentence in a specific language.
!!! The rules written here are for German and French ONLY.
"""
import sys
...
def text_to_gloss(text: str, language: str, punctuation=False) -> Gloss:
    if language not in LANGUAGE_MODELS_RULES:
        raise NotImplementedError("Don't know language '%s'. Rule-based applied for German/French only." % language)
